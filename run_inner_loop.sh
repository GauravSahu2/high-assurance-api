...
echo "⚡ INITIATING HIGH-ASSURANCE INNER LOOP (WITH BENCHMARKS)..."
...
PYTHONPATH=src TEST_MODE=true JWT_SECRET="super-secure-dev-secret-key-123456789012345678901234" gunicorn --bind 0.0.0.0:5000 --workers 1 "main:app" > server_inner.log 2>&1 &
    sleep 3
SERVER_PID=$!
