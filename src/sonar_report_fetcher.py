...
def fetch_sonar_metrics():
    ...
    params = {
        ...
        "metricKeys": "alert_status,bugs,vulnerabilities,code_smells,coverage,duplicated_lines_density,sqale_index,reliability_rating,security_rating,sqale_rating"
    }
    ...
    try:
        ...
        with open(report_path, "w") as f:
            ...
            f.write(f"| 🔓 **Vulnerabilities** | {measures.get('vulnerabilities', '0')} | {measures.get('security_rating', 'N/A')} |\n")
            f.write(f"| ☣️ **Code Smells** | {measures.get('code_smells', '0')} | {measures.get('sqale_rating', 'N/A')} |\n")
            ...
            f.write("This project adheres to high-assurance standards. All critical and high issues must be resolved before deployment.\n\n")
            f.write("---\n")
